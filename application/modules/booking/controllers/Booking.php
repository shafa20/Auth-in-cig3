...
class Booking extends BaseController
{
    ...
    function bookingListing()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'shafa : Booking';
    ...
    function add()
    {
        ...
        {
            $this->global['pageTitle'] = 'shafa : Add New Booking';
    ...
    function edit($bookingId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'shafa : Edit Booking';
    ...
    function delete($bookingId = NULL)
    {
        if (!$this->hasDeleteAccess()) {
            ...
            $bookingInfo = $this->bm->getBookingInfo($bookingId);
            if (!$bookingInfo) {
            ...
            // Delete the brand
            $result = $this->bm->deleteBooking($bookingId);
    
            if ($result) {
                $this->session->set_flashdata('success', 'Booking deleted successfully');
            } else {
                $this->session->set_flashdata('error', 'Booking delete  failed');
            }
