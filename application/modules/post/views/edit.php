		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="box box-primary">
					...
					<form role="form" action="<?php echo base_url() ?>post/editPost" method="post" id="editPost"
						...
						<div class="box-body">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control required"
											value="<?php echo $postTitle; ?>" id="postTitle" name="postTitle"
											maxlength="256" />
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										if (!empty ($post_pic) && is_array($post_pic)) {
											foreach ($post_pic as $image) {
												echo '<div>';
												echo '<img src="' . base_url('uploads/' . $image) . '" style="width: 50px; height: 50px; margin-right: 5px;" />';
												echo '<input type="checkbox" name="remove_images[]" value="' . $image . '"> Remove';
												echo '</div>';
											}
										}
										?>
								...
								<div class="col-md-12">
									<div class="form-group">
										<label for="post_pic">Upload New Images</label>

										<input type="file" class="form-control custom-file-input" id="post_pic"
											name="post_pic[]" multiple accept="image/*">
